...
const Artikels = () => {
  ...
  const deleteArtikels = async (tokens, id) => {
    try {
      const res = await axios.delete('https://backend-hwy6vx3s6a-uc.a.run.app/api/admin-only/v1/article/' + id, {
        headers: {
  ...
  const addArtikels = async (tokens, body) => {
    try {
      const res = await axios.post('https://backend-hwy6vx3s6a-uc.a.run.app/api/admin-only/v1/article', body, {
        headers: {
          Authorization: `Bearer ${tokens}`,
  ...
  const editArtikels = async (tokens, id, body) => {
    try {
      const res = await axios.put('https://backend-hwy6vx3s6a-uc.a.run.app/api/admin-only/v1/article/' + id, body, {
        headers: {
          Authorization: `Bearer ${tokens}`,
          'Content-Type': 'multipart/form-data',
        },
