...
const Konselors = () => {
  ...
  const addKonselor = async (tokens, body) => {
    try {
      const res = await axios.post('https://backend-hwy6vx3s6a-uc.a.run.app/api/admin-only/v1/konselor', body, {
        headers: {
  ...
  const deleteKonselor = async (tokens, id) => {
    try {
      const res = await axios.delete('https://backend-hwy6vx3s6a-uc.a.run.app/api/admin-only/v1/konselor/' + id, {
        headers: {
          Authorization: `Bearer ${tokens}`,
        },
      });
  ...
  const editKonselor = async (tokens, id, body) => {
    try {
      const res = await axios.put('https://backend-hwy6vx3s6a-uc.a.run.app/api/admin-only/v1/konselor/' + id, body, {
        headers: {
          Authorization: `Bearer ${tokens}`,
        },
      });
