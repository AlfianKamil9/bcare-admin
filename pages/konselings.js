...
const Konselings = () => {
  ...
  const addKonseling = async (tokens, body) => {
    try {
      const res = await axios.post('https://backend-hwy6vx3s6a-uc.a.run.app/api/admin-only/v1/konseling', body, {
        headers: {
  ...
  const deleteKonseling = async (tokens, id) => {
    try {
      const res = await axios.delete('https://backend-hwy6vx3s6a-uc.a.run.app/api/admin-only/v1/konseling/' + id, {
        headers: {
          Authorization: `Bearer ${tokens}`,
        },
      });
  ...
  const editKonseling = async (tokens, id, body) => {
    try {
      const res = await axios.put('https://backend-hwy6vx3s6a-uc.a.run.app/api/admin-only/v1/konseling/' + id, body, {
        headers: {
          Authorization: `Bearer ${tokens}`,
        },
      });
